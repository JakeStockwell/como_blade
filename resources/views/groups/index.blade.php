<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <div x-data="{ show: false }" @click.away = "show = false">
            <button @click="show = ! show" class="w-full mb-2 py-2 pl-1 pr-3 px-0 mx-2 bg-red-300 text-sm font-semibold text-left rounded-xl" style="display:inline">
                Make New Group
            ...
            <form x-show="show" style="display:none" method="POST" action="{{ route('groups.store') }}">
                ...
                <x-primary-button class="mt-4">{{ __('Make Group') }}</x-primary-button>
            </form>
        </div>
